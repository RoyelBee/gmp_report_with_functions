...
def dash_kpi_generator(name):
    ...
    # Open Image file
    image = Image.open(r'./Images/gpm_stock_report.png')
    draw = ImageDraw.Draw(image)
    font = ImageFont.truetype('./Images/FrancoisOne-Regular.ttf', 30)
    # Draw on the image
    ...
    #
    draw.text((70, 220), currency_converter(sum(total_target)), font=font, fill=(255, 255, 255))
    draw.text((260, 220), currency_converter(sum(total_sales)),  font=font, fill=(255, 255, 255))
